    ...
    <div class="row">
                ...
                <div class="widget-body  am-fr">
                    ...
                    <div class="am-u-sm-12">
                        ...
                        id="example-r">
                            ...
                            <tbody>
                            	<?php $status = [1=>'下单未发货','出库,未收货','收货完成','作废'];
                            	?>
                                ...
                                <tr class="even gradeC">
                                    ...
                                    <td>
                                        <div class="tpl-table-black-operation">
                                            ...
                                            <a href="{{url('store/orders/'.$v->order_id.'/edit')}}" >
                                                <i class="am-icon-pencil">
                                                </i>
                                                修改订单
                                            </a>
                                            <a href="{{url('store/orders/'.$v->order_id)}}" >
                                                <i class="am-icon-pencil">
                                                </i>
                                                订单详情
                                            </a>
        ...
        function DelOrders(order_id){
            ...
            layer.confirm('是否确认删除？', {
                ...
                $.post("{{url('store/orders/')}}/"+order_id,{'_method':'DELETE','_token':"{{csrf_token()}}"},function(data){
                if(data.status == 0){
