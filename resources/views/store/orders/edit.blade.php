        ...
        <div class="widget am-cf">
            ...
            <div class="widget-body am-fr">
        		...
        		<?php
        			$arr = ['1'=>'一般订单','加急订单'];
        		?>
                <form class="am-form tpl-form-border-form tpl-form-border-br" action="{{url('store/orders/'.$data['order_id'])}}" method="post" >
                ...
                {{csrf_field()}}
                    ...
                    <div class="am-form-group" >
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" disabled class="tpl-form-input" id="user-name" name="order_type" value="{{ $arr[$data['order_type']] }}">
                        </div>
                    </div>
                    <div class="am-form-group" >
                        <label for="user-name" class="am-u-sm-3 am-form-label" >
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" disabled class="tpl-form-input" id="user-name" name="user_name" value="{{ $data['user_name'] }}">
                        </div>
                    </div>
                     <div class="am-form-group" >
                        <label for="user-name" class="am-u-sm-3 am-form-label" >
