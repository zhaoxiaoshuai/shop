...
<div class="b_btm_bg b_btm_c">
    <div class="b_btm">
        <table border="0" style="width:210px; height:62px; float:left; margin-left:75px; margin-top:30px;" cellspacing="0" cellpadding="0">
            <tr>
                <td width="72"><img src="{{ asset('home/assets/images/b1.png') }}" width="62" height="62" /></td>
                <td><h2>正品保障</h2>正品行货  放心购买</td>
            </tr>
        </table>
        <table border="0" style="width:210px; height:62px; float:left; margin-left:75px; margin-top:30px;" cellspacing="0" cellpadding="0">
            <tr>
                <td width="72"><img src="{{ asset('home/assets/images/b2.png') }}" width="62" height="62" /></td>
                <td><h2>满38包邮</h2>满38包邮 免运费</td>
            </tr>
        </table>
        <table border="0" style="width:210px; height:62px; float:left; margin-left:75px; margin-top:30px;" cellspacing="0" cellpadding="0">
            <tr>
                <td width="72"><img src="{{ asset('home/assets/images/b3.png') }}" width="62" height="62" /></td>
                <td><h2>天天低价</h2>天天低价 畅选无忧</td>
            </tr>
        </table>
        <table border="0" style="width:210px; height:62px; float:left; margin-left:75px; margin-top:30px;" cellspacing="0" cellpadding="0">
            <tr>
                <td width="72"><img src="{{ asset('home/assets/images/b4.png') }}" width="62" height="62" /></td>
...
<div class="b_nav">
    ...
    <div class="b_er">
        <div class="b_er_c"><img src="{{ asset('home/assets/images/erweima.jpg') }}" width="118" height="118" /></div>
...
<div class="btmbg">
     ...
     <div style="margin-left:35%;">
        @if(!empty($link))
        @foreach($link as $k => $v)
            <span class="btn btn-link"><a href="{{ $v['link_href'] }}" title="{{ $v['link_name'] }}">{{ $v['link_name'] }}</a></span>&nbsp;&nbsp;
        @endforeach
        @endif
    </div>
    <div class="btm">
