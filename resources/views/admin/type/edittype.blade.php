      ...
      <input type="hidden" name="_method" value="put">
        ...
        <div class="am-form-group">
          <label class="am-u-sm-3 am-form-label">是否显示 :
            <span class="tpl-form-line-small-title"></span></label>
          <div class="am-u-sm-9">
            <input name="type_show" type="radio" value="{{ $v['type_show'] }}" />是&nbsp&nbsp
            <input name="type_show" type="radio" value="{{ $v['type_show'] }}" checked="checked" />否
        </div><br></br>
        ...
        <div class="am-form-group">
          <label class="am-u-sm-3 am-form-label">设为首页推荐 :
            <span class="tpl-form-line-small-title"></span></label>
          <div class="am-u-sm-9">
            <input name="type_recommend" type="checkbox" value="{{ $v['type_recommend'] }}" />精品&nbsp&nbsp
            <input name="type_recommend" type="checkbox" value="{{ $v['type_recommend'] }}" checked="checked" />最新&nbsp&nbsp
            <input name="type_recommend" type="checkbox" value="{{ $v['type_recommend'] }}" />热门
        </div><br></br>
        ...
        <div class="am-form-group">
          ...
          <div class="am-u-sm-9">
            <textarea name="type_describe" class="" rows="10" id="user-intro" placeholder="{{ $v['type_describe'] }}"></textarea>
          </div>
        </div>
         @endforeach
        <div class="am-form-group">
