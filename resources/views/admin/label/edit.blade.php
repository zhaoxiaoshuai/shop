...
@section('content')
    <div class="widget-body am-fr">
        ...
        @endif
        <form action="{{ url('admin/label/'.$data->id) }}" method="POST" class="am-form tpl-form-border-form tpl-form-border-br">
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-9">
                    <input type="text" class="tpl-form-input" id="user-name" name="label_name" value="{{ $data->label_name }}" placeholder="请输入标签名">
                    <small><font><font>请输入标签名</font></font></small>
                </div>
            </div>
            <div class="am-form-group">
